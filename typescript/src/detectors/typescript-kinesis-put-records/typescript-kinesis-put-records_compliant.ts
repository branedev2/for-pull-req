...
// {fact rule=typescript-kinesis-put-records@v1.0 defects=0}
import AWS from 'aws-sdk';

const kinesis = new AWS.Kinesis({ apiVersion: '2013-12-02', region: 'us-west-2' });

async function compliant(): Promise<void> {
    ...
    try {
        ...
        console.error('Error sending batch records:', (error as Error).message);
    }
}
