...
// {fact rule=java-hadoopusegetfilestatusisdir@v1.0 defects=1}
...
public class HadoopUseGetFileStatusIsDirNonCompliant {
    ...
    // Noncompliant: Use of deprecated `FileSystem.isDirectory()`.
    public void nonCompliant(Path segment, final SegmentReaderStats stats) throws Exception {
